...
enyo.kind({
    ...
    statics: (function() {
        ...
        function rstr_hmac_rmd160(key, data) {
            ...
            var hash = binl_rmd160(ipad.concat(enigma.encode.toLittleEndians(data)), 512 + data.length * 8);
            var hmachash = binl_rmd160(opad.concat(hash), 512 + 160);
        ...
        function binl_rmd160(key, len) {
            ...
            for (var i = 0; i < bkey.length; i += 16) {
                ...
                for (var j = 0; j <= 79; ++j) {
                    ...
                    T = safe_add(T, bkey[i + rmd160_r1[j]]);
                    ...
                    T = safe_add(T, bkey[i + rmd160_r2[j]]);
        ...
        return {
            hash: function(inString) {
                ...
                var endianHash = binl_rmd160(inString);
            ...
            hmac: function(inString, inData) {
                ...
                var stringHash = rstr_hmac_rmd160(inString, inData);
                return new enigma.Hash(stringHash);
            }
        };
    })()
